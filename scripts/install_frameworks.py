...
FRAMEWORKS = [
    {
        "name": "langchain",
        "packages": ["langchain", "langchain-community", "langchain-core", "langchain-openai", "chromadb>=0.5.0,<0.6.0", "numpy<2.0"],
        "description": "LangChain v1.x — LLM orchestration framework for chains, agents, and RAG (with langchain-openai + chromadb)",
    ...
    {
        "name": "autogen",
        "packages": ["autogen-ext", "autogen-core", "autogen-agentchat"],
        "description": "Microsoft AutoGen (v0.7+) — multi-agent conversation framework with autogen_ext + autogen_core",
        "import_name": "autogen_ext",
        "keywords": ["autogen", "multi-agent", "agent chat", "autogen_ext"],
        "timeout": 300,
    },
    {
        "name": "crewai",
        "packages": ["crewai", "crewai-tools", "chromadb>=0.5.0,<0.6.0", "numpy<2.0"],
        "description": "CrewAI — role-playing autonomous AI agents framework (with chromadb + numpy compat)",
        "import_name": "crewai",
    ...
    {
        "name": "autogpt-forge",
        "packages": ["autogpt-forge", "agpt"],
        "description": "AutoGPT Forge — framework for building autonomous AI agents (with agpt package)",
        "import_name": "autogpt",
        "keywords": ["autogpt", "auto-gpt", "autonomous agent", "forge"],
        "timeout": 180,
    },
]
