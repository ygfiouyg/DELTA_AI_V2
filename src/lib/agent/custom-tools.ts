...
export const textToSpeech: AgentTool = {
  ...
  execute: async (args) => {
    const code = `
import sys; sys.path.insert(0, "/usr/local/lib/python3.11/dist-packages"); sys.path.insert(0, "/usr/lib/python3/dist-packages"); sys.path.insert(0, "/usr/local/lib/python3.12/dist-packages"); sys.path.insert(0, "/usr/lib/python3.12/dist-packages"); import edge_tts, asyncio, json
async def run():
...
export const transcribeAudio: AgentTool = {
  ...
  execute: async (args) => {
    const code = `
import sys; sys.path.insert(0, "/usr/local/lib/python3.11/dist-packages"); sys.path.insert(0, "/usr/lib/python3/dist-packages"); sys.path.insert(0, "/usr/local/lib/python3.12/dist-packages"); sys.path.insert(0, "/usr/lib/python3.12/dist-packages"); import json
try:
...
export const extractPdfText: AgentTool = {
  ...
  execute: async (args) => {
    const code = `
import sys; sys.path.insert(0, "/usr/local/lib/python3.11/dist-packages"); sys.path.insert(0, "/usr/lib/python3/dist-packages"); sys.path.insert(0, "/usr/local/lib/python3.12/dist-packages"); sys.path.insert(0, "/usr/lib/python3.12/dist-packages"); import pymupdf, json
...
export const analyzeData: AgentTool = {
  ...
  execute: async (args) => {
    const code = `
import sys; sys.path.insert(0, "/usr/local/lib/python3.11/dist-packages"); sys.path.insert(0, "/usr/lib/python3/dist-packages"); sys.path.insert(0, "/usr/local/lib/python3.12/dist-packages"); sys.path.insert(0, "/usr/lib/python3.12/dist-packages"); import pandas as pd, json
...
export const createChart: AgentTool = {
  ...
  execute: async (args) => {
    const code = `
import sys; sys.path.insert(0, "/usr/local/lib/python3.11/dist-packages"); sys.path.insert(0, "/usr/lib/python3/dist-packages"); sys.path.insert(0, "/usr/local/lib/python3.12/dist-packages"); sys.path.insert(0, "/usr/lib/python3.12/dist-packages"); import matplotlib
matplotlib.use('Agg')
...
export const scrapeWeb: AgentTool = {
  ...
  execute: async (args) => {
    const code = `
import sys; sys.path.insert(0, "/usr/local/lib/python3.11/dist-packages"); sys.path.insert(0, "/usr/lib/python3/dist-packages"); sys.path.insert(0, "/usr/local/lib/python3.12/dist-packages"); sys.path.insert(0, "/usr/lib/python3.12/dist-packages"); import trafilatura, json
...
export const httpRequest: AgentTool = {
  ...
  execute: async (args) => {
    const code = `
import sys; sys.path.insert(0, "/usr/local/lib/python3.11/dist-packages"); sys.path.insert(0, "/usr/lib/python3/dist-packages"); sys.path.insert(0, "/usr/local/lib/python3.12/dist-packages"); sys.path.insert(0, "/usr/lib/python3.12/dist-packages"); import requests, json
...
export const storeInMemory: AgentTool = {
  ...
  execute: async (args) => {
    const code = `
import sys; sys.path.insert(0, "/usr/local/lib/python3.11/dist-packages"); sys.path.insert(0, "/usr/lib/python3/dist-packages"); sys.path.insert(0, "/usr/local/lib/python3.12/dist-packages"); sys.path.insert(0, "/usr/lib/python3.12/dist-packages"); import chromadb, json
...
export const fastAnalyzeData: AgentTool = {
  ...
  execute: async (args) => {
    const code = `
import sys; sys.path.insert(0, "/usr/local/lib/python3.11/dist-packages"); sys.path.insert(0, "/usr/lib/python3/dist-packages"); sys.path.insert(0, "/usr/local/lib/python3.12/dist-packages"); sys.path.insert(0, "/usr/lib/python3.12/dist-packages"); import polars as pl, json
...
export const analyzeAudio: AgentTool = {
  ...
  execute: async (args) => {
    const code = `
import sys; sys.path.insert(0, "/usr/local/lib/python3.11/dist-packages"); sys.path.insert(0, "/usr/lib/python3/dist-packages"); sys.path.insert(0, "/usr/local/lib/python3.12/dist-packages"); sys.path.insert(0, "/usr/lib/python3.12/dist-packages"); import librosa, json, numpy as np
...
export const processMedia: AgentTool = {
  ...
  execute: async (args) => {
    const code = `
import sys; sys.path.insert(0, "/usr/local/lib/python3.11/dist-packages"); sys.path.insert(0, "/usr/lib/python3/dist-packages"); sys.path.insert(0, "/usr/local/lib/python3.12/dist-packages"); sys.path.insert(0, "/usr/lib/python3.12/dist-packages"); import ffmpeg, json
...
export const sendMqttCommand: AgentTool = {
  ...
  execute: async (args) => {
    const code = `
import sys; sys.path.insert(0, "/usr/local/lib/python3.11/dist-packages"); sys.path.insert(0, "/usr/lib/python3/dist-packages"); sys.path.insert(0, "/usr/local/lib/python3.12/dist-packages"); sys.path.insert(0, "/usr/lib/python3.12/dist-packages"); import paho.mqtt.client as mqtt, json
client = mqtt.Client()
...
export const serialCommand: AgentTool = {
  ...
  execute: async (args) => {
    const code = `
import sys; sys.path.insert(0, "/usr/local/lib/python3.11/dist-packages"); sys.path.insert(0, "/usr/lib/python3/dist-packages"); sys.path.insert(0, "/usr/local/lib/python3.12/dist-packages"); sys.path.insert(0, "/usr/lib/python3.12/dist-packages"); import serial, json, time
...
export const automateDesktop: AgentTool = {
  ...
  execute: async (args) => {
    const code = `
import sys; sys.path.insert(0, "/usr/local/lib/python3.11/dist-packages"); sys.path.insert(0, "/usr/lib/python3/dist-packages"); sys.path.insert(0, "/usr/local/lib/python3.12/dist-packages"); sys.path.insert(0, "/usr/lib/python3.12/dist-packages"); import pyautogui, json
...
export const removeImageBackground: AgentTool = {
  ...
  execute: async (args) => {
    const code = `
import sys; sys.path.insert(0, "/usr/local/lib/python3.11/dist-packages"); sys.path.insert(0, "/usr/lib/python3/dist-packages"); sys.path.insert(0, "/usr/local/lib/python3.12/dist-packages"); sys.path.insert(0, "/usr/lib/python3.12/dist-packages"); import rembg, json
...
export const sendWhatsapp: AgentTool = {
  ...
  execute: async (args) => {
    const code = `
import sys; sys.path.insert(0, "/usr/local/lib/python3.11/dist-packages"); sys.path.insert(0, "/usr/lib/python3/dist-packages"); sys.path.insert(0, "/usr/local/lib/python3.12/dist-packages"); sys.path.insert(0, "/usr/lib/python3.12/dist-packages"); import pywhatkit, json
try:
...
export const readDicom: AgentTool = {
  ...
  execute: async (args) => {
    const code = `
import sys; sys.path.insert(0, "/usr/local/lib/python3.11/dist-packages"); sys.path.insert(0, "/usr/lib/python3/dist-packages"); sys.path.insert(0, "/usr/local/lib/python3.12/dist-packages"); sys.path.insert(0, "/usr/lib/python3.12/dist-packages"); import pydicom, json
...
export const downloadInstagram: AgentTool = {
  ...
  execute: async (args) => {
    const code = `
import sys; sys.path.insert(0, "/usr/local/lib/python3.11/dist-packages"); sys.path.insert(0, "/usr/lib/python3/dist-packages"); sys.path.insert(0, "/usr/local/lib/python3.12/dist-packages"); sys.path.insert(0, "/usr/lib/python3.12/dist-packages"); import instaloader, json
...
export const getStockData: AgentTool = {
  ...
  execute: async (args) => {
    const code = `
import sys; sys.path.insert(0, "/usr/local/lib/python3.11/dist-packages"); sys.path.insert(0, "/usr/lib/python3/dist-packages"); sys.path.insert(0, "/usr/local/lib/python3.12/dist-packages"); sys.path.insert(0, "/usr/lib/python3.12/dist-packages"); import yfinance as yf, json
...
export const testAPI: AgentTool = {
  ...
  execute: async (args) => {
    const code = `
import sys; sys.path.insert(0, "/usr/local/lib/python3.11/dist-packages"); sys.path.insert(0, "/usr/lib/python3/dist-packages"); sys.path.insert(0, "/usr/local/lib/python3.12/dist-packages"); sys.path.insert(0, "/usr/lib/python3.12/dist-packages"); import schemathesis, json
...
export const render3D: AgentTool = {
  ...
  execute: async (args) => {
    const code = `
import sys; sys.path.insert(0, "/usr/local/lib/python3.11/dist-packages"); sys.path.insert(0, "/usr/lib/python3/dist-packages"); sys.path.insert(0, "/usr/local/lib/python3.12/dist-packages"); sys.path.insert(0, "/usr/lib/python3.12/dist-packages"); import trimesh, json
...
export const manageCalendar: AgentTool = {
  ...
  execute: async (args) => {
    const code = `
import sys; sys.path.insert(0, "/usr/local/lib/python3.11/dist-packages"); sys.path.insert(0, "/usr/lib/python3/dist-packages"); sys.path.insert(0, "/usr/local/lib/python3.12/dist-packages"); sys.path.insert(0, "/usr/lib/python3.12/dist-packages"); import vobject, json
...
export const extractTables: AgentTool = {
  ...
  execute: async (args) => {
    const code = `
import sys; sys.path.insert(0, "/usr/local/lib/python3.11/dist-packages"); sys.path.insert(0, "/usr/lib/python3/dist-packages"); sys.path.insert(0, "/usr/local/lib/python3.12/dist-packages"); sys.path.insert(0, "/usr/lib/python3.12/dist-packages"); import tabula, json
...
export const getRedditPosts: AgentTool = {
  ...
  execute: async (args) => {
    const code = `
import sys; sys.path.insert(0, "/usr/local/lib/python3.11/dist-packages"); sys.path.insert(0, "/usr/lib/python3/dist-packages"); sys.path.insert(0, "/usr/local/lib/python3.12/dist-packages"); sys.path.insert(0, "/usr/lib/python3.12/dist-packages"); import praw, json
try:
