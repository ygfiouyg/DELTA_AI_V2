...
export const CALLABLE_TOOLS: CallableTool[] = [
  ...
  // ── PDF Tools ──
  {
    ...
    execute: async (args) => {
      const code = `
import sys; sys.path.insert(0, "/usr/local/lib/python3.11/dist-packages"); sys.path.insert(0, "/usr/lib/python3/dist-packages"); sys.path.insert(0, "/usr/local/lib/python3.12/dist-packages"); sys.path.insert(0, "/usr/lib/python3.12/dist-packages"); import pdfplumber, json
...
`;
  ...
  },
  {
    ...
    execute: async (args) => {
      const code = `
import sys; sys.path.insert(0, "/usr/local/lib/python3.11/dist-packages"); sys.path.insert(0, "/usr/lib/python3/dist-packages"); sys.path.insert(0, "/usr/local/lib/python3.12/dist-packages"); sys.path.insert(0, "/usr/lib/python3.12/dist-packages"); import pytesseract
from PIL import Image
import json
...
`;
  ...
  },
  {
    ...
    execute: async (args) => {
      const code = `
import sys; sys.path.insert(0, "/usr/local/lib/python3.11/dist-packages"); sys.path.insert(0, "/usr/lib/python3/dist-packages"); sys.path.insert(0, "/usr/local/lib/python3.12/dist-packages"); sys.path.insert(0, "/usr/lib/python3.12/dist-packages"); import qrcode, json
...
`;
  ...
  },
  {
    ...
    execute: async (args) => {
      const code = `
import sys; sys.path.insert(0, "/usr/local/lib/python3.11/dist-packages"); sys.path.insert(0, "/usr/lib/python3/dist-packages"); sys.path.insert(0, "/usr/local/lib/python3.12/dist-packages"); sys.path.insert(0, "/usr/lib/python3.12/dist-packages"); import yt_dlp, json, os
opts = {
...
`;
  ...
  },
  {
    ...
    execute: async (args) => {
      const code = `
import sys; sys.path.insert(0, "/usr/local/lib/python3.11/dist-packages"); sys.path.insert(0, "/usr/lib/python3/dist-packages"); sys.path.insert(0, "/usr/local/lib/python3.12/dist-packages"); sys.path.insert(0, "/usr/lib/python3.12/dist-packages"); import asyncio, edge_tts, json
async def run():
...
`;
  ...
  },
  {
    ...
    execute: async (args) => {
      const code = `
import sys; sys.path.insert(0, "/usr/local/lib/python3.11/dist-packages"); sys.path.insert(0, "/usr/lib/python3/dist-packages"); sys.path.insert(0, "/usr/local/lib/python3.12/dist-packages"); sys.path.insert(0, "/usr/lib/python3.12/dist-packages"); import nltk
...
`;
  ...
  // ── Fun ──
  {
    ...
    execute: async () => {
      const code = `
import sys; sys.path.insert(0, "/usr/local/lib/python3.11/dist-packages"); sys.path.insert(0, "/usr/lib/python3/dist-packages"); sys.path.insert(0, "/usr/local/lib/python3.12/dist-packages"); sys.path.insert(0, "/usr/lib/python3.12/dist-packages"); import pyjokes, json
...
`;
  ...
  },
  {
    ...
    execute: async (args) => {
      const code = `
import sys; sys.path.insert(0, "/usr/local/lib/python3.11/dist-packages"); sys.path.insert(0, "/usr/lib/python3/dist-packages"); sys.path.insert(0, "/usr/local/lib/python3.12/dist-packages"); sys.path.insert(0, "/usr/lib/python3.12/dist-packages"); import cowsay, json
...
`;
  ...
  // NLP: NLTK
  {
    ...
    execute: async (args) => {
      const code = `
import sys; sys.path.insert(0, "/usr/local/lib/python3.11/dist-packages"); sys.path.insert(0, "/usr/lib/python3/dist-packages"); sys.path.insert(0, "/usr/local/lib/python3.12/dist-packages"); sys.path.insert(0, "/usr/lib/python3.12/dist-packages"); import nltk, json
...
`;
  ...
  // Image: Albumentations (augmentation)
  {
    ...
    execute: async (args) => {
      const code = `
import sys; sys.path.insert(0, "/usr/local/lib/python3.11/dist-packages"); sys.path.insert(0, "/usr/lib/python3/dist-packages"); sys.path.insert(0, "/usr/local/lib/python3.12/dist-packages"); sys.path.insert(0, "/usr/lib/python3.12/dist-packages"); import albumentations as A
import cv2
import json
...
`;
  ...
  // PyMuDF: advanced PDF
  {
    ...
    execute: async (args) => {
      const code = `
import sys; sys.path.insert(0, "/usr/local/lib/python3.11/dist-packages"); sys.path.insert(0, "/usr/lib/python3/dist-packages"); sys.path.insert(0, "/usr/local/lib/python3.12/dist-packages"); sys.path.insert(0, "/usr/lib/python3.12/dist-packages"); import pymupdf, json, os
...
`;
  ...
  // Data: xlsxwriter (advanced Excel)
  {
    ...
    execute: async (args) => {
      const code = `
import sys; sys.path.insert(0, "/usr/local/lib/python3.11/dist-packages"); sys.path.insert(0, "/usr/lib/python3/dist-packages"); sys.path.insert(0, "/usr/local/lib/python3.12/dist-packages"); sys.path.insert(0, "/usr/lib/python3.12/dist-packages"); import xlsxwriter, json
...
`;
  ...
  // Arrow: date/time
  {
    ...
    execute: async () => {
      const code = `
import sys; sys.path.insert(0, "/usr/local/lib/python3.11/dist-packages"); sys.path.insert(0, "/usr/lib/python3/dist-packages"); sys.path.insert(0, "/usr/local/lib/python3.12/dist-packages"); sys.path.insert(0, "/usr/lib/python3.12/dist-packages"); import arrow, json
cities = {
    "Cairo": "Africa/Cairo",
    "Riyadh": "Asia/Riyadh",
    "Dubai": "Asia/Dubai",
...
`;
  ...
  // Structlog: structured logging
  {
    ...
    execute: async (args) => {
      const code = `
import sys; sys.path.insert(0, "/usr/local/lib/python3.11/dist-packages"); sys.path.insert(0, "/usr/lib/python3/dist-packages"); sys.path.insert(0, "/usr/local/lib/python3.12/dist-packages"); sys.path.insert(0, "/usr/lib/python3.12/dist-packages"); import orjson, json
try:
